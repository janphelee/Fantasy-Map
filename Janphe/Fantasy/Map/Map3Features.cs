    ...
    internal class Map3Features
    {
        ...
        public void reMarkFeatures()
        {
            ...
            for (ushort i = 1; queue[0] != -1; ++i)
            {
                ...
                var land = cells.r_height[start] >= 20;
        ...
        private string defineLakeGroup(int cell, int number)
        {
            ...
            var height = cells.r_neighbor_r[cell].Select(c => cells.r_height[c]).Max();
